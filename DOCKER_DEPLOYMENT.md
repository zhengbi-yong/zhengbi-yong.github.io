...
7. **最新版本** - 使用所有软件的最高兼容版本

---

## 📦 软件版本清单

### 核心运行时版本（2025-12-28 最新）

| 组件 | 版本 | 说明 |
|------|------|------|
| **Node.js** | 22-alpine | 最新LTS版本，性能提升约20% |
| **PostgreSQL** | 16-alpine | 最新稳定版，性能优化和新的SQL特性 |
| **Redis** | 7.4-alpine | 最新7.x版本，性能和稳定性提升 |
| **Nginx** | 1.27-alpine | 最新主线版本，HTTP/3支持 |
| **Rust** | 1.84-slim | 最新稳定版，支持edition2024 |
| **Next.js** | 16.0.10 | 最新版本，React 19支持 |
| **React** | 19.2.1 | 最新版本 |
| **pnpm** | 10.24.0 | 最新版本，性能优化 |
