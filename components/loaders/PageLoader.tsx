...
export default function PageLoader({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center bg-white/90 dark:bg-gray-950/90 backdrop-blur-sm"
      aria-label="页面加载中"
      role="status"
    >
      {/* 可选的粒子背景 */}
      {shouldShowParticles && (
        <div className="absolute inset-0">
          <ParticleBackground
            particleCount={getOptimalParticleCount(20)}
            speed={0.3}
          />
        </div>
      )}
