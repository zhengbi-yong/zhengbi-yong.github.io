        ...
        >
          ...
          <div className={cn(styles.exploreColumn1, 'flex w-full flex-col gap-3 sm:gap-4')}>
            ...
            <div
              className={cn(
                styles.exploreItem,
                styles.exploreItem1,
                'border-primary/15 relative h-[200px] overflow-hidden rounded-xl border bg-gray-50/75 sm:h-[220px] md:h-[264px] dark:border-neutral-700/50/75'
              )}
            >
            ...
            <div
              className={cn(
                styles.exploreItem,
                styles.exploreItem2,
                'border-primary/15 relative h-[180px] overflow-hidden rounded-xl border bg-gray-50/75 sm:h-[200px] dark:border-neutral-700/50/75'
              )}
            >
              <div className={styles.content}>
                <h3>Faves</h3>
          ...
          <div className="col-span-1 w-full sm:col-span-2 lg:col-span-1">
            <div
              className={cn(
                styles.exploreItem,
                'border-primary/15 relative overflow-hidden rounded-xl border bg-gray-50/75 dark:border-neutral-700/50/75'
              )}
            >
              <div
                className={cn(
