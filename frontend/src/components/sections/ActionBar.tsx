...
export default function ActionBar({
  ...
  return (
    ...
    >
      <div className="flex max-w-[92vw] items-center gap-1 rounded-2xl bg-[var(--theme-bg-secondary)] px-2 py-2 text-neutral-100 shadow-[0_6px_28px_rgba(0,0,0,0.25)] ring-1 ring-white/10 sm:gap-2 dark:bg-[var(--theme-bg-secondary)]">
        {/* Logo block */}
