  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mb-6 text-center pt-6 pb-4">
        <div className="mx-auto mb-3 h-10 w-64 animate-pulse rounded-lg bg-gray-200 sm:h-12 md:h-14" />
...
const BookSkeleton = memo(function BookSkeleton() {
  return (
    <div className="p-2">
      <div className="h-full rounded-lg border border-[var(--theme-border)] bg-[var(--theme-bg)] p-4 shadow-sm dark:border-gray-700">
        {/* 书籍封面骨架 */}
        <div className="mb-3 h-32 w-full animate-pulse rounded bg-gray-200 " />
