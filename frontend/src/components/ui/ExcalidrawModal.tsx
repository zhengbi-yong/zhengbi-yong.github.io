...
export function ExcalidrawModal({
  ...
  return (
    <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black">
      <div className="m-4 flex h-[90vh] w-full max-w-7xl flex-col rounded-lg bg-[var(--theme-bg)] shadow-xl">
        {/* Header */}
        <div className="flex flex-shrink-0 items-center justify-between border-b border-[var(--theme-border)] p-4 dark:border-gray-700">
