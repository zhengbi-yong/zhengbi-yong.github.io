        ...
        >
          ...
          >
            ...
            <div className="relative h-full">
              {/* 书籍封面 - 添加边缘发光和按下效果 */}
              <motion.div
                className="relative flex h-full flex-col justify-between overflow-hidden rounded-xl border-2 border-border bg-card p-4 shadow-lg transition-all duration-300 dark:border-border"
                whileHover={
