...
export function InteractiveMap({
  ...
  if (!isClient) {
    return (
      <div
        className={`flex h-96 items-center justify-center rounded-lg bg-muted dark:bg-card ${className}`}
      >
        <div className="text-muted-foreground dark:text-muted-foreground">加载地图中...</div>
      </div>
    )
  }
