      ...
      <div className={heroClasses}>
        ...
        <div className="relative z-10 grid gap-10 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-background/5 p-4 text-sm text-gray-200 backdrop-blur-lg">
          ...
          <div className="relative min-h-[22rem] rounded-2xl border border-white/10 bg-black/20 backdrop-blur">
            ...
            <div className="pointer-events-none absolute inset-x-6 bottom-6 flex justify-between text-xs tracking-[0.4em] text-muted-foreground uppercase">
