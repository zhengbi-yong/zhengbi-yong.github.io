  ...
  return (
    <div className="fixed bottom-4 left-4 z-50 font-mono text-xs">
      ...
      <Button
        ...
        className="mb-2 flex items-center gap-2 border-yellow-300 bg-[var(--theme-warning)]/10 dark:border-yellow-700 dark:bg-yellow-900/30"
      >
      ...
      {/* 调试面板 */}
      {isOpen && (
        <div className="w-80 rounded-lg border border-border bg-background p-4 shadow-lg dark:border-border dark:bg-card">
          {/* 标题栏 */}
          <div className="mb-4 flex items-center justify-between border-b border-border pb-2 dark:border-border">
          ...
          <div className="space-y-3">
            <div>
              <h4 className="mb-1 font-medium text-foreground dark:text-foreground">Performance</h4>
            ...
            {/* 内存信息 */}
            <div>
              <h4 className="mb-1 font-medium text-foreground dark:text-foreground">Memory</h4>
              <div className="space-y-1 text-muted-foreground dark:text-muted-foreground">
                <div className="flex justify-between">
                  <span>Used:</span>
            ...
            {/* 网络信息 */}
            <div>
              <h4 className="mb-1 font-medium text-foreground dark:text-foreground">Network</h4>
              <div className="space-y-1 text-muted-foreground dark:text-muted-foreground">
                <div className="flex justify-between">
                  <span>Pending:</span>
            ...
            {/* 工具按钮 */}
            <div className="space-y-2 border-t border-border pt-2 dark:border-border">
              <Button
                variant="outline"
                size="sm"
                onClick={clearCache}
