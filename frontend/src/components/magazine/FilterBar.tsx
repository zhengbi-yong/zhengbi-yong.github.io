...
export default function FilterBar({ categories, onFilterChange, className = '' }: FilterBarProps) {
  ...
  return (
    <div className={className} data-testid="filter-bar">
      <div className="sticky top-16 z-40 border-b bg-[var(--theme-bg)]/80 backdrop-blur-md transition-all dark:border-gray-700/80">
        <div className="container mx-auto px-4 py-3">
          ...
          {(activeCategory !== '全部' || searchQuery) && (
            <motion.div
              ...
              className="mt-3 flex items-center gap-2 text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]"
            ...
            >
              ...
              <button
                ...
                className="ml-2 text-xs text-gray-500 hover:text-[var(--theme-fg)] dark:text-[var(--theme-fg-secondary)] dark:hover:text-gray-300"
              >
                清除全部
              </button>
            </motion.div>
