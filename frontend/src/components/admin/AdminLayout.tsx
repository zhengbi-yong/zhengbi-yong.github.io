...
// import Link from 'next/link'  // unused — kept for reference
...
// import { cn } from '@/components/lib/utils'  // unused — kept for reference
...
function AdminLayoutInner({ children }: AdminLayoutProps) {
  ...
  // const pathname = usePathname()  // unused — kept for reference
