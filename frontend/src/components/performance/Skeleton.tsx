...
export function Skeleton({ className, loading = true, children }: SkeletonProps) {
  ...
  return (
    <div
      className={clsx(
        'animate-pulse rounded-md bg-gradient-to-r from-[var(--surface-elevated)] via-[var(--surface-subtle)] to-[var(--surface-elevated)]',
...
export function CodeBlockSkeleton({ className = '' }: SkeletonProps) {
  return (
    <div className={clsx('rounded-lg bg-[var(--surface-elevated)] p-4', className)}>
      <div className="space-y-2">
