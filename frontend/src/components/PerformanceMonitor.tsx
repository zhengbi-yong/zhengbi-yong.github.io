...
export function PerformanceIndicator() {
  ...
  return (
    <div className="fixed right-4 bottom-4 z-50 rounded-lg bg-[var(--theme-bg)] p-2 shadow-lg">
      <div className="text-xs text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">Performance Score</div>
      <div
