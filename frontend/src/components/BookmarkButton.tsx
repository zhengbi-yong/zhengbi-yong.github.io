        ...
        <svg
          className={`h-5 w-5 transition-all ${
            isBookmarked
              ...
              : 'fill-none text-gray-600 group-hover:text-yellow-500 dark:group-hover:text-yellow-400'
          }`}
      ...
      <button
        ...
        className={`${baseClasses} ${className} inline-flex items-center gap-2 rounded-md border px-4 py-2 text-sm font-medium transition-colors disabled:opacity-50 ${
          isBookmarked
            ...
            : 'border-[var(--theme-border)] bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700'
        }`}
      >
        <svg
    ...
    <button
      ...
      className={`${baseClasses} ${className} inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium shadow-sm transition-all disabled:opacity-50 ${
        isBookmarked
          ...
          : 'bg-white text-gray-700 shadow-gray-300/50 hover:bg-gray-50 dark:shadow-gray-700/30 dark:hover:bg-gray-700'
      }`}
    >
      <svg
