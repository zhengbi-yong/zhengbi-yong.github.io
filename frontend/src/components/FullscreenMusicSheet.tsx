      ...
      >
        <div className="flex-1 flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            <div className="h-8 w-8 border-2 border-[var(--theme-accent)] border-t-transparent rounded-full animate-spin" />
            <p className="text-[10px] uppercase tracking-[0.2em] text-[var(--theme-fg-secondary)]/60">Loading...</p>
          </div>
        </div>
      </div>
    )
          ...
          <div className="hidden sm:flex items-center gap-2">
            <button
              ...
              className={cn(
                ...
                isDark ? 'text-slate-300' : 'text-[var(--theme-fg)]'
              )}
              aria-label="Zoom out"
            >
              −
                    ...
                    <div
                      className={cn(
                        ...
                        isDark
                          ...
                          : 'border-[var(--theme-accent)] border-t-transparent'
                      )}
                    />
                    <p
                      className={cn(
