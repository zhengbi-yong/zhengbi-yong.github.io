    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="文章摘要（可选）"
          className="w-full min-h-[80px] rounded-md border border-[var(--theme-border)] bg-[var(--theme-bg)] px-3 py-2 text-sm dark:border-gray-700"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full rounded-md border border-[var(--theme-border)] bg-[var(--theme-bg)] px-3 py-2 text-sm dark:border-gray-700"
        >
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <select
            ...
            className="flex-1 rounded-md border border-[var(--theme-border)] bg-[var(--theme-bg)] px-3 py-2 text-sm dark:border-gray-700"
          >
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full min-h-[60px] rounded-md border border-[var(--theme-border)] bg-[var(--theme-bg)] px-3 py-2 text-sm dark:border-gray-700"
        />
      </div>
