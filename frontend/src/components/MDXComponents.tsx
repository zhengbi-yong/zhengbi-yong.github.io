...
const MusicSheet = dynamic(() => import('./MusicSheet').then((mod) => mod.default), {
  loading: () => (
    <div className="my-6 flex h-64 items-center justify-center rounded-lg border border-dashed border-[var(--theme-border)] dark:border-gray-700">
      <div className="flex flex-col items-center gap-3">
        <div className="border-t-primary-500 h-8 w-8 animate-spin rounded-full border-4 border-[var(--theme-border)]" />
        <p className="text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">正在加载乐谱组件...</p>
      </div>
    </div>
  ),
})
...
const ChemicalStructure = dynamic(
  ...
  {
    loading: () => (
      <div className="my-6 flex h-96 items-center justify-center rounded-lg border border-dashed border-[var(--theme-border)] dark:border-gray-700">
        <div className="flex flex-col items-center gap-3">
          <div className="border-t-primary-500 h-8 w-8 animate-spin rounded-full border-4 border-[var(--theme-border)]" />
          <p className="text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">正在加载3D结构查看器...</p>
        </div>
      </div>
    ),
  }
  ...
  () => import('./chemistry/RDKitStructure').then((mod) => mod.default),
  {
    loading: () => (
      <div className="my-6 flex h-96 items-center justify-center rounded-lg border border-dashed border-[var(--theme-border)] dark:border-gray-700">
        <div className="flex flex-col items-center gap-3">
          <div className="border-t-primary-500 h-8 w-8 animate-spin rounded-full border-4 border-[var(--theme-border)]" />
          <p className="text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">正在加载2D结构查看器...</p>
        </div>
      </div>
    ),
  }
...
const MoleculeFingerprint = dynamic(
  ...
  {
    loading: () => (
      <div className="my-6 items-center justify-center rounded-lg border border-dashed border-[var(--theme-border)] p-4 dark:border-gray-700">
        <div className="flex flex-col items-center gap-3">
          <div className="border-t-primary-500 h-6 w-6 animate-spin rounded-full border-4 border-[var(--theme-border)]" />
          <p className="text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">正在加载分子指纹...</p>
        </div>
      </div>
    ),
  }
  ...
  () => import('./gaussian-splat/GaussianSplat').then((mod) => mod.default),
  {
    loading: () => (
      <div className="my-6 flex h-96 items-center justify-center rounded-lg border border-dashed border-[var(--theme-border)] dark:border-gray-700">
        <div className="flex flex-col items-center gap-3">
          <div className="border-t-primary-500 h-8 w-8 animate-spin rounded-full border-4 border-[var(--theme-border)]" />
          <p className="text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">Loading 3D Gaussian Splat viewer...</p>
        </div>
      </div>
    ),
  }
...
const EChartsComponent = dynamic(() => import('./charts').then((mod) => mod.EChartsComponent), {
  loading: () => (
    <div className="my-6 flex h-64 items-center justify-center rounded-lg border border-dashed border-[var(--theme-border)] dark:border-gray-700">
      <div className="flex flex-col items-center gap-3">
        <div className="border-t-primary-500 h-8 w-8 animate-spin rounded-full border-4 border-[var(--theme-border)]" />
        <p className="text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">正在加载图表组件...</p>
      </div>
    </div>
  ),
})
