  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mb-6 text-center pt-6 pb-4">
        ...
        <p className="mx-auto max-w-2xl text-sm text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">
      ...
      {bookShelfData.books.length === 0 && bookShelfData.uncategorized.length === 0 && (
        <div className="py-12 text-center">
          <p className="text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">暂无文章</p>
        </div>
      )}
    </div>
  )
