  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-screen">
        {/* 顶部导航栏 */}
        <div className="sticky top-0 z-20 border-b border-border/50 bg-background shadow-sm dark:border-border/50 dark:bg-background">
          ...
          >
            {book.chapters.length === 0 ? (
              <div className="py-12 text-center">
                <p className="text-lg text-muted-foreground dark:text-muted-foreground">暂无章节</p>
              </div>
            ) : (
