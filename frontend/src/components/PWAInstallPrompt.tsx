...
// iOS Safari 需要手动添加到主屏幕的提示
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 max-w-sm w-full animate-slide-up">
      <div className="bg-background dark:bg-card rounded-lg shadow-2xl border border-border dark:border-border p-6">
        {/* 关闭按钮 */}
        <button
          onClick={handleDismiss}
          className="absolute top-2 right-2 text-muted-foreground hover:text-muted-foreground dark:hover:text-gray-300"
          aria-label="关闭"
        >
          <X className="h-5 w-5" />
        </button>
        ...
        <div className="flex items-start space-x-4">
          <div className="flex-shrink-0">
            <div className="w-12 h-12 bg-[var(--theme-info-muted)] dark:bg-blue-900 rounded-lg flex items-center justify-center">
              <Download className="h-6 w-6 text-primary dark:text-primary" />
            </div>
          </div>
          <div className="flex-1">
            ...
            {/* 特性列表 */}
            <ul className="text-sm text-muted-foreground dark:text-muted-foreground space-y-1 mb-4">
            ...
            <button
              ...
              className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-primary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors"
            >
              立即安装
            </button>
          </div>
      ...
      <div className="bg-background dark:bg-card rounded-lg shadow-2xl border border-border dark:border-border p-6">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            {/* 步骤说明 */}
            <ol className="text-sm text-muted-foreground dark:text-muted-foreground space-y-2 mb-4 list-decimal list-inside">
            ...
            {/* 演示图 */}
            <div className="bg-secondary dark:bg-secondary rounded-lg p-4 mb-4 text-center">
            ...
            <button
              onClick={onDismiss}
              className="w-full inline-flex justify-center items-center px-4 py-2 border border-border dark:border-border text-sm font-medium rounded-md text-foreground dark:text-foreground bg-background dark:bg-card hover:bg-muted dark:hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors"
            >
              知道了
            </button>
          </div>
