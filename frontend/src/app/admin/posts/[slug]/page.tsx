                  ...
                  <td className="px-4 py-4">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setComparison(prev => {
                          // 优先设置 version1，然后 version2
                          if (!prev.version1 && checked) {
                            return { ...prev, version1: version }
              ...
              <div>
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
                  ...
                  <details className="cursor-pointer">
                    <summary className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">
                      查看完整内容对比
                    </summary>
                    <div className="mt-4 grid grid-cols-2 gap-4">
                      <div>
                        <p className="mb-2 text-xs font-medium text-gray-700 dark:text-gray-300">旧版本内容:</p>
                        <div className="max-h-96 overflow-y-auto rounded border border-gray-300 bg-white p-3 text-sm dark:border-gray-600 dark:bg-gray-800">
                          {comparison.version1.content}
                        </div>
                      </div>
                      <div>
                        <p className="mb-2 text-xs font-medium text-gray-700 dark:text-gray-300">新版本内容:</p>
                        <div className="max-h-96 overflow-y-auto rounded border border-gray-300 bg-white p-3 text-sm dark:border-gray-600 dark:bg-gray-800">
