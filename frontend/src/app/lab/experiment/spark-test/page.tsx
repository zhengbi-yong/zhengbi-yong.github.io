...
export default function SparkTestPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <p className="mb-8 text-[var(--theme-fg-secondary)]">
        Powered by{' '}
      ...
      <section className="mb-10">
        ...
        <GaussianSplat
          ...
          lookAt={[0, 0, 0]}
        />
        <p className="mt-3 text-sm text-[var(--theme-fg-secondary)]">
      ...
      <section className="mb-10">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="text-[var(--theme-fg-secondary)] dark:text-[var(--theme-fg-tertiary)]">
