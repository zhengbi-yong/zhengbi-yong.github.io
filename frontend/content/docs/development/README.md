...
- Files linked from this page are treated as maintained developer-facing docs.
- Historical summaries remain under `docs/development/archive/`.
- If a document is not linked here, verify it before treating it as canonical.
