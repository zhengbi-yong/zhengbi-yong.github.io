...
- Fresh VPS: start with [Automated Compose Deploy](../../../../../../../docs/deployment/guides/server/automated-compose-deploy.md)
- Existing server with legacy stack already behind system nginx: use [System Nginx Cutover](../../../../../../../docs/deployment/guides/server/system-nginx-cutover.md)
- Need the shortest operator cheat sheet: use [Quick Deployment](../../../../../../../docs/deployment/guides/server/quick-deployment.md)

## Not covered here

Clustered multi-node deployment is now documented under:
