...
- configuring production env files
- checking published ports and bind hosts
- looking up routine operational commands
- tuning Compose or cluster runtime behavior
