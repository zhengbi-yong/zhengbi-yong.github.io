-- ============================================
-- Phase 4.2: Fix Database Violations (v2)
-- ============================================

-- ============================================
-- 1. post_stats: fillfactor=70 + handle FK
-- ============================================
...
-- Create new table with fillfactor=70
...
-- Re-add FK constraint (outside transaction - post_stats now exists)
