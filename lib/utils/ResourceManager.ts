...
export class ResourceManager {
  ...
  private eventListeners: Map<
    Element,
    Array<{ event: string; handler: EventListener; options?: boolean | AddEventListenerOptions }>
  > = new Map()
