...
> ⚠️ 注意：路线图仅覆盖 ultradesign.md 中的项目，缺失的功能包括：版本管理、CQRS、阅读进度追踪等。

| 阶段 | 内容 | 预期周期 | 关键交付 | 状态 |
|------|------|----------|----------|------|
| 1 | 安全基线 | 1-2 周 | HttpOnly Cookie, CSRF 防护 | ✅ 已完成 |
| 2 | 数据库优化 | 2-3 周 | UUIDv7 迁移, ltree 评论 | ✅ 基本完成 |
| 3 | API 契约 | 2 周 | Orval 配置, TS 客户端 | ✅ 已完成 |
| 4 | 认证升级 | 2-3 周 | WebAuthn 集成 | ⏳ 未开始 |
| 5 | 搜索 CDC | 2 周 | MeiliBridge 部署 | ✅ 已实现 |
| 6 | K3s 迁移 | 3-4 周 | 生产级集群 | 🟡 部分实现（已有 Manifests，生产状态待确认） |
