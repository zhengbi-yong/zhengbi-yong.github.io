...
- [search/page.tsx](../../../../../frontend/src/app/search/page.tsx) owns the route entry
- [SearchPageClient.tsx](../../../../../frontend/src/app/search/SearchPageClient.tsx#L1) handles client search state, debounced fetching, and URL updates
- tests live in:
  - [resolveBackendApiBaseUrl.test.ts](../../../../../frontend/tests/lib/api/resolveBackendApiBaseUrl.test.ts)
...
- search routes live in [routes/search.rs](../../../../../backend/crates/api/src/routes/search.rs)
- the API exposes full search, suggestions, and trending endpoints

### Search index service

- [search_index.rs](../../../../../backend/crates/api/src/search_index.rs#L1) wraps Meilisearch client setup, index configuration, document sync, and query execution
- searchable attributes include title, summary, content, tags, and category name
- filterable fields include category and tags

### Async indexing

- [outbox.rs](../../../../../backend/crates/api/src/outbox.rs#L1) emits search index events instead of blocking API writes
- [worker/main.rs](../../../../../backend/crates/worker/src/main.rs#L1) claims outbox records and applies indexing operations asynchronously
